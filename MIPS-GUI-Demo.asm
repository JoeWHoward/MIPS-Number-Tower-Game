...
# and down.  (Notice that the y direction is the opposite of math tradition.)d

# X-Coordinate is distance from left border
# Y-Coordinate is distance from top border
    li $a0,100
    li $a1,25
    li $a2,10
    li $a3,50
